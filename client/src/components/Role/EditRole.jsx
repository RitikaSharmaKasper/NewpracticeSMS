// sms/frontend/src/components/Role/EditRole.jsx
import React, { useState, useEffect } from "react";
import { useParams, useNavigate, Link } from "react-router-dom";
import { toast } from "react-toastify";
import { MdKeyboardArrowLeft } from "react-icons/md";
import api from "../../config/axiosInstance";
import { ALL_MODULES, DEFAULT_PERMISSIONS } from "../../components/utils/roleDefaults";
...
const EditRole = () => {
      ...
      if (role.modulePermissions) {
        ...
        Object.keys(ALL_MODULES).forEach((module) => {
          if (!enhancedPermissions[module]) {
            ...
            enhancedPermissions[module] = {
              export: enhancedPermissions[module].export || false,
              import: enhancedPermissions[module].import || false,
              ...
              all: enhancedPermissions[module].export &&
                enhancedPermissions[module].import &&
  ...
  const togglePermission = (module, permission) => {
    setModulePermissions((prev) => {
      ...
      updated.all = updated.export && updated.import && updated.create && updated.read && updated.update && updated.delete;
      return {
        ...prev,
        [module]: updated,
      };
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await api.put(`/api/role/update/${id}`, roleData);
  ...
  // ✅ SMS-Specific groupedModules (Same as CreateRole)
  const groupedModules = {
    ...
    Resources: ["Library", "Transport", "Facilities"],
    Communication: ["Notice", "Messages", "Events", "Calendar"],
    "Online Test": ["Online Test", "Question Bank", "Exam Paper"],
    Homework: ["Homework"],
    "Study Material": ["Study Material", "Online Class"],
      ...
      >
        ...
        <div style={{ marginBottom: "24px", maxWidth: "400px" }}>
          <label style={{ display: "block", marginBottom: "6px" }}>
            <span style={{ color: "#727681", fontSize: "12px", fontFamily: "Inter" }}>
              Role Name
            </span>
        ...
        <h2 style={{ fontFamily: "Inter", fontSize: "16px", fontWeight: "500", color: "#0E101A", marginBottom: "12px" }}>
          Permissions
        </h2>
                ...
                {modules.map((module) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ width: "400px", textAlign: "left", fontSize: "14px", color: "#0E101A" }}>{module}</div>
