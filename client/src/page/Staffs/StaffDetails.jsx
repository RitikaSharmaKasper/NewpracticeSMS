...
function DetailsContent({ active, oneStaff }) {
  ...
  const handleDownloadDocument = async (fileUrl, title) => {
    if (!fileUrl) {
      toast.error("No file URL available");
      return;
    }
        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 rounded-lg lg:grid-cols-2  mt-6 gap-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-[0_0_8px_0_rgba(0,0,0,0.15)]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  ["Full Name", `${oneStaff?.personalInfo?.staffName}`],
                  ["Gender", `${oneStaff?.personalInfo?.gender}`],
                  ["Date of Birth", `${oneStaff?.personalInfo?.dob}`],
                  [
                    "Age",
                    oneStaff?.personalInfo?.dob
                      ? `${
                          new Date().getFullYear() -
                          new Date(oneStaff.personalInfo.dob).getFullYear()
                        } Years`
                      : "N/A",
                  ],
                  ["Blood Group", `${oneStaff?.personalInfo?.bloodGroup}`],
                  [
                    "Marital Status",
                    `${oneStaff?.personalInfo?.maritalStatus}`,
                  ],
                  ["Religion", `${oneStaff?.personalInfo?.religion}`],
                  ["Nationality", `${oneStaff?.personalInfo?.nationality}`],
                ].map(([label, value]) => (
                  <div key={label}>
              ...
              <div className="space-y-4">
                <div className="border-b pb-4 border-[#E6E6E6]">
                  ...
                  <p className="font-medium">
                    {oneStaff?.personalInfo?.aadhaarNumber}
                  </p>
                </div>
                <div className="border-b pb-4 border-[#E6E6E6]">
                  <p className="text-sm text-[#8A8A8A]">PAN Number</p>
                  <p className="font-medium">
                    {oneStaff?.personalInfo?.panNumber || "-"}
                  </p>
                </div>
                <div className="border-b pb-4 border-[#E6E6E6]">
                  <p className="text-sm text-[#8A8A8A]">Languages Known</p>
                  <p className="font-medium">
                    {oneStaff?.personalInfo?.languageKnown || "-"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white mt-6 rounded-lg shadow-[0_0_8px_0_rgba(0,0,0,0.15)] p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-b pb-5 border-[#E6E6E6]">
              <div>
                ...
                <p className="font-medium flex items-center gap-2">
                  ...
                  {oneStaff?.contactInfo?.mobileNumber || "-"}
                </p>
              </div>
              <div>
            ...
            <div className="mt-5 space-y-2 border-b pb-5 border-[#E6E6E6]">
              ...
              <p className="font-medium">
                {oneStaff?.currentAddress?.addressLine},
                {oneStaff?.currentAddress?.city},
                {oneStaff?.currentAddress?.state},
                {oneStaff?.currentAddress?.country},
                {oneStaff?.currentAddress?.pincode}
              </p>
            </div>
            <div className="mt-5 space-y-2 border-b pb-5 border-[#E6E6E6]">
              <p className="text-sm text-[#8A8A8A]">Parmanent Address</p>
              <p className="font-medium">
                {oneStaff?.permanentAddress?.addressLine || "-"},
                {oneStaff?.permanentAddress?.city},
                {oneStaff?.permanentAddress?.state},
                {oneStaff?.permanentAddress?.country},
                {oneStaff?.permanentAddress?.pincode}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-2">
              <div>
                ...
                <p className="font-medium">
                  {oneStaff?.contactInfo?.emergencyName || "-"}
                </p>
              </div>
              <div>
                <p className="text-sm text-[#8A8A8A]">Relation</p>
                <p className="font-medium">
                  {oneStaff?.contactInfo?.emergencyRelation || "-"}
                </p>
              </div>
              <div>
                <p className="text-sm text-[#8A8A8A]">Phone</p>
                <p className="font-medium">
                  {oneStaff?.contactInfo?.emergencyPhone || "-"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white mt-6  rounded-xl shadow-[0_0_8px_0_rgba(0,0,0,0.15)]  p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 border-b pb-3 border-[#E6E6E6]">
              {[
                ...
                ["Spouse Name", `${oneStaff?.personalInfo?.spouseName || "-"}`],
                [
                  "Spouse Occupation",
                  `${oneStaff?.personalInfo?.spouseOccupation || "-"}`,
                ],
                [
                  "Spouse Phone",
                  `${oneStaff?.personalInfo?.spousePhone || "-"} `,
                ],
                [
                  "Number of Children",
                  `${oneStaff?.personalInfo?.numberOfChildren || "-"}`,
                ],
              ].map(([l, v]) => (
                <div key={l}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
              <div>
                ...
                <p className="font-medium">
                  {oneStaff?.personalInfo?.fatherName || "-"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="font-medium">
                  {oneStaff?.personalInfo?.motherName || "-"}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-xl border border-gray-200 overflow-hidden">
              <table className="w-full text-sm text-gray-800">
                ...
                <tbody className="divide-y divide-gray-200">
                  {oneStaff.qualificationInfo?.qualifications.map((item, i) => (
          ...
          <div className="mt-6 p-4 bg-white rounded-lg shadow-[0_0_8px_0_rgba(0,0,0,0.15)]">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6">
              {/* <------------------------------------------- CARD ---------------------------------------> */}
              {oneStaff?.documents.map((item, index) => (
  ...
  */}
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    ...
                    <button className="px-4 py-2 bg-white rounded-lg flex gap-2 items-center justify-center text-[#696969] border-2 border-[#9C9C9C] w-full sm:w-auto"
                             ...
                             onClick={() => handleDownloadDocument(item?.fileUrl, item?.title)}
          ...
          <div className="bg-white mt-6 shadow-[0_0_8px_0_rgba(0,0,0,0.15)]   rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-6 border-b border-[#E6E6E6]">
              <div>
                ...
                <p className="font-medium">{oneStaff?.employmentInfo?.employeeId}</p>
              </div>
              <div>
                <p className="text-sm text-[#8A8A8A]">Department</p>
                <p className="font-medium">{oneStaff?.employmentInfo?.department}</p>
              </div>
              <div>
                <p className="text-sm text-[#8A8A8A]">Role</p>
                <p className="font-medium">{oneStaff?.employmentInfo?.role}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-6 border-b border-[#E6E6E6]">
              <div>
                ...
                <p className="font-medium">{oneStaff?.employmentInfo?.dateOfJoining}</p>
              </div>
              ...
              <div>
                ...
                <span className="inline-block mt-1 px-3 py-1 text-sm border-[#b3b3b3] border rounded-md font-medium">
                  {oneStaff?.employmentInfo?.employeeType}
                </span>
              </div>

              <div>
                <p className="text-sm text-[#8A8A8A]">Years of Service</p>
                <p className="font-medium">{oneStaff?.qualificationInfo?.totalExperience}</p>
              </div>
            </div>
            ...
            <div className="pt-6">
              ...
              <p className="font-medium">{oneStaff?.employmentInfo?.workShift}</p>
            </div>
          </div>
...
const navigate = useNavigate();
  ...
  bg-linear-to-r from-[#9796F0] to-[#FBC7D4]"
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:justify-between">
          ...
          border-2 border-white overflow-hidden"
              >
                <img
                  ...
                  alt={oneStaff?.profilePhoto?.publicId}
            ...
            <div className="flex-1 w-full">
              ...
              <div className="flex gap-15 mt-4">
                {[
                  ["Employee ID", `${oneStaff?.employmentInfo?.employeeId}`],
                  ["Role", `${oneStaff?.employmentInfo?.role}`],
                  ["Department", `${oneStaff?.employmentInfo?.department}`],
                  ["Joined", `${oneStaff?.employmentInfo?.dateOfJoining}`],
                ].map(([label, value], idx) => (
                  ...
                  <div className="flex gap-4 items-center">
                    ...
                    <div className="flex flex-col text-[#1C1C1C]">
                      ...
                      <span className="font-semibold text-[#F97316]">
                        {oneStaff?.qualificationInfo?.totalExperience} years
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div>
            <div className="bg-[#0B3142] p-2 rounded-lg flex justify-start lg:justify-end">
              ...
              onClick={() => navigate(`/edit-staffs/${oneStaff?._id || id}`)}>
                <LiaUserEditSolid />
                Edit
              </button>
            </div>
    ...
    "
      ...
      <div className="">
        <DetailsContent active={active} oneStaff={oneStaff} />
      </div>
    </div>
  );
}
