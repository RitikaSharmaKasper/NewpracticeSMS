...
const filteredStaffData = staffDatas.filter((item) => {
  // Search filter
  const searchLower = searchTerm.toLowerCase();
  const matchesSearch = item.staff.toLowerCase().includes(searchLower) ||
  ...
  // Status filter
  const matchesStatus = statusFilterValue === "Status" || 
...
<div className="text-[10px] md:text-[12px] lg:text-[14px]" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
  ...
  <div className="relative inline-block" tyle={{ width: "124px" }}>
    <button
      onClick={() => setShowSectionDropdown(!showSectionDropdown)}
      className="bg-[#EFF2F2] rounded-[9px] px-5 py-2.5 text-[12px] text-[#1C1C1C] w-full cursor-pointer flex items-center justify-between gap-4 hover:bg-[#E5E7E8] transition-colors"
    >
      <span>{sectionFilter || "All"}</span>
      <svg
    ...
    {showSectionDropdown && (
      <div className="absolute z-50 w-full mt-1.5 bg-white border border-[#E6E6E6] rounded-[9px] shadow-lg overflow-hidden">
        ...
        <button
          ...
          className={`w-full text-left px-4 py-2.5 text-[13px] hover:bg-[#F5F7F7] transition-colors ${
            sectionFilter === "A" ? "bg-[#F5F7F7] font-medium text-[#0B3142]" : "text-[#1C1C1C]"
          }`}
        >
          A
        </button>
        <button
          ...
          className={`w-full text-left px-4 py-2.5 text-[13px] hover:bg-[#F5F7F7] transition-colors ${
            sectionFilter === "B" ? "bg-[#F5F7F7] font-medium text-[#0B3142]" : "text-[#1C1C1C]"
          }`}
        >
          B
        </button>
        <button
          ...
          className={`w-full text-left px-4 py-2.5 text-[13px] hover:bg-[#F5F7F7] transition-colors ${
            sectionFilter === "C" ? "bg-[#F5F7F7] font-medium text-[#0B3142]" : "text-[#1C1C1C]"
          }`}
        >
          C
        </button>
        <button
          ...
          className={`w-full text-left px-4 py-2.5 text-[13px] hover:bg-[#F5F7F7] transition-colors ${
            sectionFilter === "D" ? "bg-[#F5F7F7] font-medium text-[#0B3142]" : "text-[#1C1C1C]"
          }`}
        >
          D
        </button>
  ...
  <div className="relative inline-block" style={{ width: "124px" }}>
    <button
      ...
      className="bg-[#EFF2F2] rounded-[9px] px-4 py-2.5 text-[12px] text-[#1C1C1C] w-full cursor-pointer flex items-center justify-between gap-4 hover:bg-[#E5E7E8] transition-colors"
    >
      <span>{statusFilterValue || "Status"}</span>
      <svg
        className={`w-3.5 h-3.5 transition-transform duration-200 ${showStatusFilterDropdown ? "rotate-180" : ""}`}
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
    ...
    {showStatusFilterDropdown && (
      <div className="absolute z-50 w-full mt-1.5 bg-white border border-[#E6E6E6] rounded-[9px] shadow-lg overflow-hidden">
        ...
        <button
          onClick={() => {
            setStatusFilterValue("Present");
            setShowStatusFilterDropdown(false);
            setCurrentPage(1);
          }}
          className={`w-full text-left px-4 py-2.5 text-[13px] hover:bg-[#F5F7F7] transition-colors ${
            statusFilterValue === "Present" ? "bg-[#F5F7F7] font-medium text-[#0B3142]" : "text-[#1C1C1C]"
          }`}
        >
          Present
        </button>
        <button
          onClick={() => {
            setStatusFilterValue("Absent");
            setShowStatusFilterDropdown(false);
            setCurrentPage(1);
          }}
          className={`w-full text-left px-4 py-2.5 text-[13px] hover:bg-[#F5F7F7] transition-colors ${
            statusFilterValue === "Absent" ? "bg-[#F5F7F7] font-medium text-[#0B3142]" : "text-[#1C1C1C]"
          }`}
        >
          Absent
        </button>
        <button
          onClick={() => {
            setStatusFilterValue("Leave");
            setShowStatusFilterDropdown(false);
            setCurrentPage(1);
          }}
          className={`w-full text-left px-4 py-2.5 text-[13px] hover:bg-[#F5F7F7] transition-colors ${
            statusFilterValue === "Leave" ? "bg-[#F5F7F7] font-medium text-[#0B3142]" : "text-[#1C1C1C]"
          }`}
        >
          Leave
        </button>
