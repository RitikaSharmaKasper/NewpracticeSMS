        ...
        <div className="flex flex-col md:flex-row md:justify-between gap-4 p-4 items-center">
          ...
          <div className="flex gap-3 ">
            <div className="flex items-center gap-4">
              {/* Clock In Button */}
              <button className="bg-[#0BA53B] text-white px-[16px] py-[8px] rounded-xl flex items-center gap-2 font-medium">
                <span>▶</span>
                <span>Clock In</span>
              </button>
              <button className="bg-[#C92131] text-white px-[16px] py-[8px] rounded-xl flex items-center gap-2 font-medium">
              ...
              <div className="relative">
                <select className="appearance-none bg-[#E9E9E9] rounded-lg px-4 py-3 pr-10 min-w-[120px] text-[#333] outline-none cursor-pointer">
                  <option>2026</option>
                  <option>2025</option>
                  <option>2024</option>
                  <option>2023</option>
