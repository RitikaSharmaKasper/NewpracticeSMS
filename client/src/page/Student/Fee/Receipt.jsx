        ...
        <div className="flex justify-center mt-6">
          <div className="border border-[#E6E6E6] gap-1 rounded-xl">
            ...
            <div className="flex justify-between items-center border-t border-b border-[#E6E6E6] px-4 py-6 gap-12">
              <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  gap-x-12 gap-y-6">
                <div className="flex gap-2.5">
                  <span className="font-normal text-[14px] text-[#696969]">
                    Receipt Number:
                  </span>
              ...
              <table className="w-full ">
                <thead className="border-b border-[#E6E6E6]">
                  <tr className="">
                    ...
                    <th className="w-[60%] text-left px-2 py-2">Fee Header</th>
                ...
                <tbody className="border-b border-[#E6E6E6]">
                  {feeData.map((item, id) => (
                    <tr key={id} className="">
                      ...
                      <td className="text-left px-2 font-normal text-[14px] text-[#1c1c1c]">{item.feeHead}</td>
            ...
            <div className="px-6 py-4 border-b border-[#E6E6E6]">
              <div className="flex gap-6 items-center">
                <span className="text-[14px] font-normal text-[#1C1C1C]">Payment Method:</span>
            ...
            <div className="px-6 py-4 border-b border-[#E6E6E6]">
              <div className="flex gap-6 items-center">
                <span className="text-[14px] font-normal text-[#1C1C1C]">Remark:</span>
