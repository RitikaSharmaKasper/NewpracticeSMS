  ...
  return (
    <div>
      <div className="box-shadow mt-3 bg-white rounded-md">
        ...
        {/* <-------------------------------------- search & filter ------------------------------> */}
        <div className="mt-3 p-4 flex justify-between items-center gap-4">
          {/* SEARCH */}
        ...
        {/* TABLE + PREVIEW */}
        <div className="p-4">
          <div className="grid grid-cols-12 gap-4 w-full transition-all duration-300">
            {/* TABLE */}
            <div
              className={`${showPreview ? "col-span-6" : "col-span-12"} transition-all duration-300`}
            >
