...
function AttendanceChart() {
  ...
  const data = [
    { exam: "Sep", Attendance: 0 },
    { exam: "Oct", Attendance: 25 },
    { exam: "Nov", Attendance: 55 },
    { exam: "Dec", Attendance: 56 },
    { exam: "Jan", Attendance: 32 },
    { exam: "Feb", Attendance: 30 },
  ];
  ...
  <span style="color:#118AB2">Attendance%: ${d.Attendance}</span>
`);
      })
      .on("mousemove", (event) => {
      ...
      {/* Select filter Button */}
          ...
          >
            ...
            >
              ...
              >
                <option value="Class">last 6 month</option>
                <option value="Nursery">last 7 month</option>
                <option value="UKG">last 3 month</option>
